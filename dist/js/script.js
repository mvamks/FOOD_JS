...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3001/menu').then(data => {
    data.forEach(({
      img,
      altimg,
      title,
...
function forms(formsSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3001/requests', json).then(data => {
        console.log(data);
...
/* harmony import */ var _modules_calcs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calcs */ "./src/js/modules/calcs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  const modalTimerId = setTimeout(() => (0,_modules_modals__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 50000); //модальное окно появляется само через 3 секунды времени

  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', modalTimerId);
  (0,_modules_timers__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2025-10-15');
  (0,_modules_calcs__WEBPACK_IMPORTED_MODULE_4__["default"])();
